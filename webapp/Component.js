sap.ui.define(["i2d/eam/pmnotification/create/s1/util/Constants", "sap/ui/core/UIComponent", "sap/ui/model/resource/ResourceModel", "i2d/eam/pmnotification/create/s1/model/models", "sap/ui/Device", "i2d/eam/pmnotification/create/s1/controller/ErrorHandler"], function(C, U, R, m, D, E) {
    "use strict";
    return U.extend("i2d.eam.pmnotification.create.s1.Component", {
        metadata: {
            manifest: "json",
