...
sap.ui.define([
	...
	return BaseController.extend("i2d.eam.pmnotification.create.zeamntfcres1.controller.MaintainNotification", {
			...
			case CONSTANTS.ROUTES.EDIT:
				...
				if (!this.getView().byId("pmNotifLongTextEdit").isBound("content")) {
					var oCustomListItem = new sap.ui.layout.VerticalLayout({
						width: "100%",
						content: [new i2d.eam.pmnotification.create.zeamntfcres1.util.ExpandableTextArea( //eslint-disable-line no-undef
								{
									editable: false,
									rows: 5,
									value: "{ReadOnlyText}",
							...
							new i2d.eam.pmnotification.create.zeamntfcres1.util.ExpandableTextArea( //eslint-disable-line no-undef
								{
