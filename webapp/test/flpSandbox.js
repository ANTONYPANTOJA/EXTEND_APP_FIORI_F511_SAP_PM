		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#i2deampmnotificationcreates1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"i2deampmnotificationcreates1-display": {
								"semanticObject": "i2deampmnotificationcreates1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=i2d.eam.pmnotification.create.s1",
									"url": sap.ui.require.toUrl("i2d/eam/pmnotification/create/s1")
								}
							}
						}
					}
