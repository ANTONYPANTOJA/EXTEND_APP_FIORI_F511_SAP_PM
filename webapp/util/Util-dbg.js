...
sap.ui.define([
	...
	return Object.extend("i2d.eam.pmnotification.create.zeamntfcres1.util.Util", {
		...
		getFragmentDialog: function(oParent, sDialogFragmentName) {
			...
			sDialogFragmentName = "i2d.eam.pmnotification.create.zeamntfcres1.view.fragments." + sDialogFragmentName;
		...
		*/	    		
		_launchPopover: function(oParams){
			...
			oPopover = sap.ui.xmlfragment( sId,
				"i2d.eam.pmnotification.create.zeamntfcres1.view.fragments." + oParams.sFragmentName,
