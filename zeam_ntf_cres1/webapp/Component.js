...
sap.ui.define([
    ...
    "i2d/eam/pmnotification/create/zeamntfcres1/model/models",
    "sap/ui/Device",
    "i2d/eam/pmnotification/create/zeamntfcres1/controller/ErrorHandler",
    /** +add end */
],
    function (C, U, R, m, D, E) {
        "use strict";
        ...
        return U.extend("i2d.eam.pmnotification.create.zeamntfcres1.Component", {
            ...
            init: function () {
                ...
                this.getModel().setDeferredGroups([
                    C.GENERAL.NOTIFICATION_BATCH_GROUP,
                    "*",
                ]);
            ...
            createContent: function () {
              ...
              _extractStartupParameters: function () {
                ...
                if (
                  c &&
                  c.startupParameters &&
                  jQuery.isArray(c.startupParameters.navTarget) &&
                  c.startupParameters.navTarget.length > 0 &&
                  H === ""
                ) {
                ...
                if (
                  c &&
                  c.startupParameters &&
                  c.startupParameters.notificationNumber
                ) {
                ...
                if (
                  c &&
                  c.startupParameters &&
                  c.startupParameters.MaintenanceNotification
                ) {
                ...
                if (p) {
                  var u = this.getRouter().getURL(
                    N,
                    n ? { NotificationNumber: n } : {}
                  );
                  u = u + I;
