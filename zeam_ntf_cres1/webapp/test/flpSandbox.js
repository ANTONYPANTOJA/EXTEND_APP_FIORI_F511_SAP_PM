		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#i2deampmnotificationcreatezeamntfcres1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"i2deampmnotificationcreatezeamntfcres1-display": {
								"semanticObject": "i2deampmnotificationcreatezeamntfcres1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=i2d.eam.pmnotification.create.zeamntfcres1",
									"url": sap.ui.require.toUrl("i2d/eam/pmnotification/create/zeamntfcres1")
								}
							}
						}
					}
